...
public class RandomGenerator {
    ...
    public static Galaxy generateGalaxy(char planetName, int numOfPlanets, int maxRadius, int maxOrbitalPeriod) {
     ...
     */
    public static LinkedHashSet<Galaxy> generateGalaxies(char galaxyNames, char planetNames, int numOfGalaxies, int numOfPlanets, int maxRadius, int maxOrbitalPeriod) {
